...
Original file is located at
    https://colab.research.google.com/drive/1I1t_Jt7-QOiG3Mb3FVryq0Rjul5Qd_wV
"""
...
def content_loss(content_weight, content_current, content_original):
    ...
    return content_weight*((content_current-content_original)**2).sum()               #style transfer에 loss = w(현재-오리지날)^2 (유클리디안 거리기반)
    ##############################################################################
    #                               END OF YOUR CODE                             #
    ##############################################################################
